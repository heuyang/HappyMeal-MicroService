...
{
    public class CreateCustomerModelValidatorTests
    {
        private readonly CreateCustomerModelValidator _testee;

        public CreateCustomerModelValidatorTests()
        {
            _testee = new CreateCustomerModelValidator();
        }
